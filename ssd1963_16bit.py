...
class SSD1963:
    ...
    def __init__(self, RS, WR, RD, CS, RST, FIRST, r):
        ...
        self._init_width = 480
        self._init_height = 272
        self.width = 480
        self.height = 272
        self.rotation = r
    ...
    def ILI9341_SetAddressWindow(self,x1, y1, x2, y2):
        ...
        self.ILI9341_WriteData(x1)
        self.ILI9341_WriteData(x2>>8)
        self.ILI9341_WriteData(x2)
        self.ILI9341_WriteCommand(0x2b)
        self.ILI9341_WriteData(y1>>8)
        self.ILI9341_WriteData(y1)
        self.ILI9341_WriteData(y2>>8)
        self.ILI9341_WriteData(y2)
    ...
    def init(self):
        self.ILI9341_WriteCommand(0xE2) 
        self.ILI9341_WriteData(0x23)    
        self.ILI9341_WriteData(0x02)
        self.ILI9341_WriteData(0x54)
        ...
        time.sleep_ms(100)
        self.ILI9341_WriteCommand(0xE6)   
        self.ILI9341_WriteData(0x01)
        self.ILI9341_WriteData(0x1F)
        self.ILI9341_WriteData(0xFF)

        self.ILI9341_WriteCommand(0xB0)  
        self.ILI9341_WriteData(0x20)
        self.ILI9341_WriteData(0x00)
        self.ILI9341_WriteData(0x01)
        self.ILI9341_WriteData(0xDF)
        self.ILI9341_WriteData(0x01)
        self.ILI9341_WriteData(0x0F)
        self.ILI9341_WriteData(0x00)

        self.ILI9341_WriteCommand(0xB4)
        self.ILI9341_WriteData(0x02)
        self.ILI9341_WriteData(0x13)
        self.ILI9341_WriteData(0x00)
        ...
        self.ILI9341_WriteCommand(0xBA)
        self.ILI9341_WriteData(0x0F)

        self.ILI9341_WriteCommand(0xB8)
        ...
        if self.rotation == 0:                  # 0 deg
            self.ILI9341_WriteData(0x22)
        elif self.rotation == 1:                # 90 deg
            self.ILI9341_WriteData(0x21)
            ...
            self.ILI9341_WriteData(0x22)
        self.ILI9341_WriteData(self.rotation)

        self.ILI9341_WriteCommand(0xF0)
        self.ILI9341_WriteData(0x03)


        time.sleep_ms(1)

        self.ILI9341_SetAddressWindow(0, 0, 479, 271)
        self.ILI9341_WriteCommand(0x29)

        self.ILI9341_WriteCommand(0xBE)
        self.ILI9341_WriteData(0x06)
        self.ILI9341_WriteData(0xf0)
        self.ILI9341_WriteData(0x01)
        self.ILI9341_WriteData(0xf0)
        self.ILI9341_WriteData(0x00)
        self.ILI9341_WriteData(0x00)

        self.ILI9341_WriteCommand(0xd0)
        self.ILI9341_WriteData(0x0d)
