from ssd1963_16bit import SSD1963,color565
...
display = SSD1963(RS,WR,RD,CS,RST,FIRST,r=2)
xF = gfxFont( display, FreeSerifBold24pt7b )

    
display.ILI9341_FillScreen(WHITE)
   
display.ILI9341_FillRectangle(185, 50, 150, 50, color565(0,0,255))

display.ILI9341_FillRectangle(105, 140, 150, 50, color565(0,0,255))


display.ILI9341_FillRectangle(265, 140, 150, 50, color565(255,0,0))
...
xF.text(150, 180,"ON",WHITE)
xF.text(290, 180,"OFF",WHITE)
...
class Screen(object): 
    ...
    def touchscreen_press(self, x, y):
        ...
        if 105 <= x <= 145 and 155 <= y <= 185:
           led_onboard.value(1)
           display.ILI9341_FillRectangle(185, 50, 150, 50, color565(0,0,255))
           

        if 45 <= x <= 85 and 145 <= y <= 185: 
            led_onboard.value(0)
            display.ILI9341_FillRectangle(185, 50, 150, 50, color565(255,0,0))
